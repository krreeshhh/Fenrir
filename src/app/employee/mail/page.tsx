            ...
            <section>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <TemplateCard
                     ...
                     desc="Draft a tactical extension for your current window."
               ...
               <div className="w-[350px] border-r border-secondary/20 flex flex-col bg-muted/5">
                  <div className="p-6 border-b border-secondary/20 space-y-4">
                     <div className="flex items-center bg-secondary/10 border border-secondary/30 px-4 py-2.5 rounded-xl transition-all">
                        ...
                        <input type="text" placeholder="FILTER DIRECTIVES..." className="bg-transparent border-none outline-none text-xs font-bold tracking-wider w-full uppercase" />
                     </div>
                  ...
                  <div className="flex-1 overflow-y-auto custom-scrollbar">
                     {loading ? (
                        ...
                        <div className="p-10 text-center">
                           <p className="text-xs font-bold text-muted-foreground uppercase">No Communications Found</p>
                        </div>
                     ) : (
                        mails.map((mail) => (
                           <button
