      ...
      <div className="space-y-8 pb-16">
         ...
         <div className="flex items-center justify-between border-b border-secondary/50 pb-6">
            <div className="flex items-center gap-3">
               ...
               <div>
                  <h2 className="text-2xl font-bold tracking-tight">Employee Performance Index</h2>
                  <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mt-0.5">Monitor employee growth and contributions</p>
               </div>
            </div>
            <div className="text-right">
               <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Total</p>
               <p className="text-xl font-black">{employees.length} <span className="text-xs text-muted-foreground font-bold">Employees</span></p>
            </div>
         </div>
               ...
               <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {employees.slice(0, 3).map((u, i) => (
                     <div key={u.id} className={cn(
                        "bg-background border rounded-2xl p-6 text-center shadow-sm relative overflow-hidden transition-all hover:shadow-lg hover:-translate-y-1",
         ...
         <div>
            <h3 className="text-xs font-black uppercase tracking-widest text-muted-foreground flex items-center gap-2 mb-4">
               ...
               <div className="flex-1 h-px bg-secondary/60" />
               <span className="text-accent">{employees.length} records</span>
            </h3>
                              ...
                              <td className="p-4">
                                 <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                       ...
                                       <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">{u.department || "Operations"}</p>
                                    </div>
                                 </div>
                              </td>
